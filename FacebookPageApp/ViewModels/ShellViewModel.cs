...
namespace FacebookPageApp.ViewModels
{
    public class ShellViewModel : ViewModelBase
    {
        ...
        {
            NavigationService.RegisterShellViewModel(this);
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(new ShellNavigationItem("Shell_Login".GetLocalized(), Symbol.Account, typeof(LoginViewModel).FullName, null));
            //_primaryItems.Add(new ShellNavigationItem("Shell_Main".GetLocalized(), Symbol.Home, typeof(MainViewModel).FullName, null));
            //_primaryItems.Add(new ShellNavigationItem("Shell_WebView".GetLocalized(), Symbol.Document, typeof(WebViewViewModel).FullName, null));
            //_primaryItems.Add(new ShellNavigationItem("Shell_MasterDetail".GetLocalized(), Symbol.Document, typeof(MasterDetailViewModel).FullName, null));
            //_primaryItems.Add(new ShellNavigationItem("Shell_Tabbed".GetLocalized(), Symbol.Document, typeof(TabbedViewModel).FullName, null));
            //_primaryItems.Add(new ShellNavigationItem("Shell_Grid".GetLocalized(), Symbol.Document, typeof(GridViewModel).FullName, null));
            //_primaryItems.Add(new ShellNavigationItem("Shell_Chart".GetLocalized(), Symbol.Document, typeof(ChartViewModel).FullName, null));
            _secondaryItems.Add(new ShellNavigationItem("Shell_Settings".GetLocalized(), Symbol.Setting, typeof(SettingsViewModel).FullName, null));
        }
        ...
        private void Navigate(object item)
        {
            ...
            if (navigationItem != null)
            {
                string key = navigationItem.ViewModelName;
                var page = navigationItem.Parameter as FBPage;
                if (page != null)
                {
                    key = $"{key}{page.Id}";
                }
                NavigationService.Navigate(key, navigationItem.Parameter);
            }
        }
    }
}
