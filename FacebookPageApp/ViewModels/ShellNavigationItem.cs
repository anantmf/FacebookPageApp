...
namespace FacebookPageApp.ViewModels
{
    public class ShellNavigationItem : ViewModelBase
    {
        ...
        public ShellNavigationItem(string label, Symbol symbol, string viewModelName, object parameter)
        {
            this.Label = label;
            this.Symbol = symbol;
        ...
        public ShellNavigationItem(string label, IconElement icon, string viewModelName, object parameter)
        {
            this.Label = label;
